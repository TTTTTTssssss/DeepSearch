...
class DeepResearchAgent:
    ...
    def __init__(self, config: Configuration | None = None) -> None:
        ...
        # 实例化了todo_agent 和 report_agent，并且准备了可以随时生产summarizer的工厂方法
    ...
    def run(self, topic: str) -> SummaryStateOutput:
        ...
        # 根据输入的topic创建状态对象，调用planner把大问题拆成几个待办任务。
    ...
    def run_stream(self, topic: str) -> Iterator[dict[str, Any]]:
        ...
        # 若某个线程搜到了信息，大模型就进行总结，并且将结果yield到前端
        try:
    ...
    def _execute_task(
        ...
        *,
        ...
        # 使用prepare_research_context进行清洗和浓缩
